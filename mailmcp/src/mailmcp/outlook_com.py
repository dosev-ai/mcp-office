...
from mailmcp._core import _DOMAIN_RE, _EMAIL_RE, _EMAIL_VALIDATE_RE, OutlookConfig, _assert_allowed, _assert_write_enabled, _get_outlook, _mapi, _redact, get_config, get_startup_config, reload_config, set_config
