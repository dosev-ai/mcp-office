"""Hyperlink management tests — targets presentation_pptx.py only."""
...
# NOTE: test_add_disallows_javascript_url intentionally omitted here —
# it is covered by test_security.py::TestManageHyperlinksURLSchemes::test_javascript_blocked
